...
//#if DEBUG
//        //STLog(@"%s call -safeSetValue:forKey:, key或vale为nil或null", __FUNCTION__);
//#endif
//        return;
//    }
//
...
//#if DEBUG
//        //STLog(@"%s call -safeSetObject:forKey:, key或vale为nil或null", __FUNCTION__);
//#endif
//        return;
//    }
//
...
//#if DEBUG
//        //STLog(@"%s call -safeRemoveObjectForKey:, aKey为nil或null", __FUNCTION__);
//#endif
//        return;
//    }
